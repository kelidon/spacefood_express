...
import 'package:flame_layer/src/blocs/compass/compass_cubit.dart';
import 'package:flame_layer/src/blocs/game_stats/game_stats_bloc.dart';
import 'package:flame_layer/src/blocs/inventory/inventory_bloc.dart';
import 'package:flame_layer/src/flame_layer/levels_scene.dart';
...
class SpaceFoodGame extends FlameGame
  ...
  Future<void> onLoad() async {
    ...
    //load map
    images = Images(prefix: 'packages/flame_layer/assets/images/');
    assets = AssetsCache(prefix: 'packages/flame_layer/');
    const double zoom = 1;
    camera.viewfinder.zoom = zoom;
    mapComponent = await TiledComponent.load(
      'testmap.tmx',
      Vector2.all(32),
      prefix: 'packages/flame_layer/assets/tiles/',
      images: Images(prefix: 'packages/flame_layer/assets/images/'),
    );
